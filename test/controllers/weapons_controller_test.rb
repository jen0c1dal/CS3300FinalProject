...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { description: @weapon.description, dmg_dice: @weapon.dmg_dice, dmg_type: @weapon.dmg_type, int: @weapon.int, name: @weapon.name, power_level: @weapon.power_level } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { description: @weapon.description, dmg_dice: @weapon.dmg_dice, dmg_type: @weapon.dmg_type, int: @weapon.int, name: @weapon.name, power_level: @weapon.power_level } }
